...
export const CTA = ({ data, parentField = "" }) => {
  return (
    ...
    >
      ...
      ></div>
      <div className={`relative flex items-center gap-10 p-20 px-40 mb-20 max-w-desktop-full mx-auto`}>
        <div className="content-wrap w-1/3 flex-1">
          <Content
            label = {data.label}
        ...
        <div className="image-wrap flex-none">
          {data.image?.src && (
            <img
              className="image"
              alt={data.image?.alt}
        ...
        <div className="button-wrap w-1/3 flex-1 text-center">
          <Buttons
